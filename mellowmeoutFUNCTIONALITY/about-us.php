...
<html>
<head>
    <title>About Us</title> <!-- Web Tab Title -->
...
Mellow Me Out wants to be your primary choice for all your beauty and relaxation needs. We have truly soothing and calming pampering experiences available for every client. It’s an ideal place to gather with friends, reconnect with loved ones or turn to as your destination for self-renewal and stress relief.<br><br>
...
<br><br>
<a itemprop="url" href="offers.php" target="_self"  class="button default" style="">Services & Offers</a>
<a itemprop="url" href="book-now.php" target="_self" class="button  default" style="">Book Now</a>
<a itemprop="url" href="contact-us.php" target="_self" class="button default" style="">Contact Us</a>
<br><br>
